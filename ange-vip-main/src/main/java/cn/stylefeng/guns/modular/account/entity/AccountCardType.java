 ...
 * @since 2020-04-16
 */
@TableName("ag_account_card_type")
public class AccountCardType implements Serializable {
     ...
     * 卡类Id
     */
    @TableId(value = "account_card_type_id", type = IdType.ID_WORKER)
    ...
    public Long getAccountCardTypeId() {
        return accountCardTypeId;
    }

    public void setAccountCardTypeId(Long accountCardTypeId) {
        this.accountCardTypeId = accountCardTypeId;
    }
    ...
    public String toString() {
        return "CodeCardType{" +
        "accountCardTypeId=" + accountCardTypeId +
        ", appId=" + appId +
